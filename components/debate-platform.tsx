...
export function DebatePlatform() {
	...
	const debateForMultiAgent = selectedDebate
		? {
				...
				rules: {
					...
					cooldownBetweenMessages: 10,
					topicChangeVoteThreshold: 60,
					moderatorOverride: true,
					allowedMessageTypes: ["text", "mention", "question"],
					bannedWords: ["spam", "toxic", "inappropriate"],
